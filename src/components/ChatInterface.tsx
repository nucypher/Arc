    ...
    <div className="flex flex-col h-screen bg-black text-white relative overflow-hidden">
      ...
      {isAboutOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gray-900 p-6 rounded-lg max-w-2xl w-full shadow-xl border border-gray-700 relative">
            {/* Title bar */}
            <div className="absolute top-0 left-0 right-0 bg-gray-800 p-3 rounded-t-lg flex justify-between items-center">
            ...
            <div className="mt-12 text-gray-300">
              ...
              <div className="flex items-center justify-center space-x-4 mb-4">
                <a href="https://docs.waku.org/" target="_blank" rel="noopener noreferrer" className="flex items-center bg-gray-800 px-3 py-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">
                ...
                <a href="https://threshold.network/build/taco" target="_blank" rel="noopener noreferrer" className="flex items-center bg-gray-800 px-3 py-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">
